...
const ParticleSystem = function () {
  ...
  */
    self.updateColors = function (bounds) {
        ...
        console.log(OldSNeCount + " " + OldTypeIaCount + " " + OldTypeICount + " " + OldTypeIICount + " ");
        console.log(LSSTCount + " " + LSSTTypeIaCount + " " + LSSTTypeICount + " " + LSSTTypeIICount + " ");
        $("#DisplayCount").text("Old SNe : " + OldSNeCount + " Type Ia : " + OldTypeIaCount + " Type I : " + OldTypeICount +
            " Type II : " + OldTypeIICount + " LSST : " + LSSTCount + " Type Ia : " + LSSTTypeIaCount + " Type I : " + LSSTTypeICount +
            " Type II : " + LSSTTypeIICount);
    };
