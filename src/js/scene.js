...
const Scene = function(options) {
  ...
  // create the scene
  var cameraOrtho = new THREE.PerspectiveCamera(
    width / -2,
    width / 2,
    height / 2,
    height / -2,
  ...
  var geometry4 = new THREE.RingGeometry(
    0.9 * LocalGroup,
    1.0 * LocalGroup,
    64
  );
  var geometry5 = new THREE.RingGeometry(
    0.9 * observableRadius,
    1.0 * observableRadius,
    64
  );
